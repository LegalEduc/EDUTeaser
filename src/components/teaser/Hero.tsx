...
export default function Hero() {
  return (
    <section className="min-h-screen flex items-center justify-center px-5 sm:px-6 md:px-12 text-center relative overflow-hidden">
      {/* 배경 그라데이션 오브 */}
      ...
      <div className="max-w-[900px] relative z-10">
        <p
          className="inline-block text-[13px] tracking-[5px] uppercase text-gold mb-8 sm:mb-12"
        ...
        <h1
          className="font-heading text-[clamp(26px,5.5vw,60px)] font-black leading-[1.35] mb-6 sm:mb-8"
