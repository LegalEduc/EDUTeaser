...
const items = [
  { label: "연수 기간", value: "2026.\n5. 12.(화) ~ 2026. 7. 30.(목)", sub: "" },
  { label: "교육 시간", value: "매주 화·목 19:00~21:00", sub: "회당 2시간 (총 48시간)" },
  { label: "강의 방식", value: "오프라인 교육\n부트캠프장 주도 1:1 실무 워크숍", sub: "" },
...
const stats = [
  ...
  { num: "1:1", unit: "케어", label: "부트캠프장 주도 개별 강평" },
  { num: "수료후", unit: "", label: "대한변협 전문연수 인정 신청 예정" },
];
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 divide-x divide-y divide-[#e2e2e2] md:divide-y-0">
            {items.map((item, idx) => (
              ...
              >
                ...
                <p className="text-[1rem] font-semibold text-ink leading-snug mb-1 whitespace-pre-line">{item.value}</p>
